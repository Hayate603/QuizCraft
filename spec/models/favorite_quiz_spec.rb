  ...
  describe "バリデーション" do
    context "有効な場合" do
      it "ユーザーとクイズが関連付けられていれば有効であること" do
        favorite_quiz = FavoriteQuiz.new(user: user, quiz: quiz)
    ...
    context "無効な場合" do
      ...
      it "同じユーザーとクイズの組み合わせは一意でなければ無効であること" do
        ...
        duplicate_favorite_quiz = FavoriteQuiz.new(user: user, quiz: quiz)
